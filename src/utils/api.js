// utils/api.js
const API_BASE_URL = 'https://alharamtourbackend-seven.vercel.app/api';
...
export const apiRequest = async (endpoint, method = 'GET', data = null, token = null, timeout = 10000) => {
  ...
  try {
    ...
    if (error.name === 'AbortError') {
      ...
      throw new Error('Cannot connect to server. Make sure backend is running on https://alharamtourbackend-seven.vercel.app/');
    }
