...
export const AuthProvider = ({ children }) => {
  ...
  const checkBackendHealth = async () => {
    try {
      const response = await fetch('https://alharamtour-backend.vercel.app/health', {
        method: 'GET',
        headers: {
    ...
    const initializeAuth = async () => {
      ...
      if (storedToken && storedUser) {
        try {
          ...
          const response = await fetch('https://alharamtour-backend.vercel.app/api/auth/profile', {
            method: 'GET',
            headers: {
  ...
  const login = async (emailOrUsername, password) => {
    try {
      ...
      const response = await fetch('https://alharamtour-backend.vercel.app/api/auth/login', {
        method: 'POST',
        headers: { 
          'Content-Type': 'application/json',
        },
  ...
  const register = async (userData) => {
    try {
      ...
      const response = await fetch('https://alharamtour-backend.vercel.app/api/auth/register', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
